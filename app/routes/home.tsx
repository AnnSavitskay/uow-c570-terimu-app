    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-300 to-orange-300 flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 text-center shadow-2xl gap-2">
          ...
          <h1 className="text-xl mb-4">{story.subtitle.mi}</h1>
          <h1 className="text-xl text-muted-foreground">{story.title.en}</h1>
          <h1 className="text-lg text-muted-foreground mb-4">{story.subtitle.en}</h1>
          ...
          <Button
            ...
            asChild
          >
            <Link to="/story/1">Start Reading</Link>
          </Button>
        </Card>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto grow flex flex-col">
        ...
        >
          ...
          <div className="relative w-full aspect-square overflow-hidden">
            <video
              src={
                story.pages[currentPage].img ||
                "/img/placeholder.png"
              }
              poster={story.pages[currentPage].img || "/img/placeholder.png"}
              autoPlay
              loop
              muted
              playsInline
...
const story = {
  ...
  subtitle: {
    en: "Written by Tracy Gilmer",
    mi: "Māori Nā Tracy Gilmer i waihanga",
  },
  author: "Tracy Gilmer",
  ...
  pages: [
    ...
    },
    {
      ...
      img: "/img/p3.png",
      text: {
        en: "Occasionally basking in the warmth of the sun beaming down from high above. Sometimes he looks like a log… A gigantic, grey, knotty, knobbly old log.",
        mi: "Putuputu ai tana pāinaina i te mahanatanga o te rā e whiti mai ana i runga ake. I ētahi wā he poro rākau tōna rite… He kaitā, he kiwikiwi, he pūpeka, he poro rākau tawhito pakoki.",
      },
    },
    {
      id: 4,
    ...
    },
    {
      ...
      img: "/img/p6.png",
      text: {
        en: "He was here when the beautiful wāhine bathed in the river. He was here when the soldiers rode into battle of Te Tarata.",
        mi: "I konei ia i te wā e kaukau ana ngā wāhine i te awa. I konei ia i te urutomokanga a ngā hoia ki te pakanga o Te Tarata.",
      },
    },
    {
      id: 7,
      img: "/img/p7.png",
      text: {
        en: "He was here when a young Aroha sat on the rivers’ edge watching as a log floated upstream of the Waioweka river. Bewildered she sat, confused as can be. “Are my eyes deceiving me?” “How is that possible?” “How can that be?” Did that knobbly old log just wink at me?",
        mi: "I konei ia i te wā e noho ana a Aroha ki ngā tahataha o te awa e tiro ana ki te poro rākau e pōtere ana i te awa o Waioweka. He pōkīkī tana noho, he pōkaikaha tonu. “E hika, kei te tika taku titiro?” “E tareka ana?” “E pēhea nei?” “I kemo mai taua poro rākau tawhito, pakoki ki ahau?”",
      },
    },
    {
      id: 8,
